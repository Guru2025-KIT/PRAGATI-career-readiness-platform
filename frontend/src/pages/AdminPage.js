...
export default function AdminPage() {
  ...
  const TABS = [{ id:'notes',label:'⏳ Approve Notes' },{ id:'company',label:'🏢 Add Company' },{ id:'aptitude',label:'🎯 Bulk Aptitude' },{ id:'users',label:'👥 Users' }];
  return (
    <div style={{ fontFamily:"'Nunito',sans-serif" }}>
      <div style={{ marginBottom:22 }}>
        <h1 style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:'1.6rem', color:'#0f1a2e' }}>⚙️ Admin Panel</h1>
        <p style={{ color:'#7a8ba8', marginTop:4 }}>Manage notes, companies, aptitude questions, and users.</p>
      </div>
      <div style={{ display:'flex', gap:6, marginBottom:20, borderBottom:'1px solid #e8edf5' }}>
        {TABS.map(t=>(
