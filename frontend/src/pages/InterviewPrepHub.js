...
export default function InterviewPrepHub() {
  ...
  return (
    <div style={{ fontFamily: "'Nunito',sans-serif" }}>
      ...
      <div
        onClick={() => nav('/dashboard/interview-prep/avatar')}
        style={{
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontWeight: 800, fontSize: '1rem', marginBottom: 3 }}>
            AI Avatar Interviewer — Live Practice
          </div>
          <div style={{ fontSize: '.82rem', opacity: .88 }}>
            Talk to a real-time AI interviewer with voice, memory, and adaptive questions
          </div>
        </div>
        <div style={{ fontSize: '1.3rem', opacity: .8 }}>→</div>
      </div>
