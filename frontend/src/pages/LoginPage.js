  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', fontFamily: "'Nunito',sans-serif" }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 5%', position: 'relative', overflow: 'hidden', background: 'linear-gradient(150deg,#f8f9ff,#f0eeff,#e8fdfd)' }}>
        ...
        <div className="login-left-panel" style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: 420 }}>
      ...
      {/* ── Right info panel ── */}
      <div className="login-right-panel" style={{ width: 420, flexShrink: 0, background: 'linear-gradient(160deg,#042c5d,#531697,#13a1a5)', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '60px 44px', color: '#fff', overflow: 'hidden', position: 'relative' }}>
