...
| ML Service | http://process.env.ML_SERVICE_URL |
| Resume Parser | http://localhost:8080 |
| API Docs (FastAPI) | http://process.env.ML_SERVICE_URL/docs |
...
The FastAPI ML service exposes these endpoints at `http://process.env.ML_SERVICE_URL`:
