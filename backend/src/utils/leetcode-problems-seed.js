...
async function seedProblems() {
  // Only connect if NOT already connected (safe when called from a running server)
  ...
  console.log(`✅ ${added} problems added, ${updated} updated. Total: ${total}`);

  // Only disconnect if WE connected (not when called from a running server)
  if (!wasConnected) {
